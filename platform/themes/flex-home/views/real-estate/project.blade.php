            ...
            <div class="col-12">
                ...
                <p class="addresshouse">
                    ...
                    @if (setting('real_estate_display_views_count_in_detail_page', 0) == 1)
                        <span class="d-inline-block" style="margin-right: 10px"><i class="fa fa-eye"></i> {{ number_format($project->views) }} {{ __('views') }}</span>
                    @endif
                    <span class="d-inline-block"><i class="fa fa-calendar-alt"></i> {{ $project->created_at->translatedFormat('M d, Y') }}</span>
                </p>
                <div class="d-none">
    ...
    <div class="container-fluid w90 padtop30 single-post">
        <section class="general">
                ...
                <div class="col-md-8">
                    ...
                    <div class="row">
                        <div class="col-sm-6 lineheight220">
                            <div><span>{{ __('Status') }}:</span> {!! $project->status_html !!}</p></div>
                    ...
                    @if ($project->latitude && $project->longitude)
                        ...
                        <div class="d-none d-print-block">
                            <a href="https://maps.google.com/?ll={{ $project->latitude }},{{ $project->longitude }}" class="text-decoration-none">
                    ...
                    @else
                        ...
                        <div class="d-none d-print-block">
                            <a href="https://www.google.com/maps/search/{{ urlencode($project->location) }}" class="text-decoration-none">
                                {{ $project->location ?: $address }}
                            </a>
                        </div>
                    @endif
            ...
            <div class="projecthome mb-2">
                @php
                    $propertiesForSale = app(\Botble\RealEstate\Repositories\Interfaces\PropertyInterface::class)
            ...
            <div class="projecthome mb-2">
                @php
                    $propertiesForRent = app(\Botble\RealEstate\Repositories\Interfaces\PropertyInterface::class)
                        ->getPropertiesByConditions(
                        [
                            're_properties.project_id' => $project->id,
