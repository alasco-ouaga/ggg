                    ...
                    <div class="topbar-right">
                        ...
                        @if (is_plugin_active('real-estate') && RealEstateHelper::isLoginEnabled())
                            <ul class="topbar-items">
                                ...
                                @else
                                    <li class="login-item">
                                        <li class="login-item ml-1 mr-3">
                                            <a href="{{ route('public.account.login') }}"><i class="fas fa-sign-in-alt"></i>&nbsp;{{ __('Login') }}</a>
                                        </li>
                                        <li class="login-item ml-3 mr-1">
                                            <a href="{{ route('public.account.register') }}"><i class="fas fa-user"></i>  {{ __('Register') }}</a>
                                        </li>
                                    </li>
                                @endif
                            </ul>
                                ...
                                <div class="main-menu-nav d-lg-flex">
                                    <div>
                                        <ul class="navbar-nav" style="margin-top:15px">
                                            <li class="nav-item" style="margin-left:3px;margin-right:3px">
                                                <a class="nav-link active" aria-current="page" href="{{ url('/properties') }}">Properties</a>
                                            </li>
                                            <li class="nav-item" style="margin-left:3px;margin-right:3px">
                                                <a class="nav-link active" aria-current="page" href="{{ url('/agents') }}">Agents</a>
                                            </li>
                                            <li class="nav-item" style="margin-left:3px;margin-right:3px">
                                                <a class="nav-link active" aria-current="page" href="{{ url('/about-us') }}">Nous contacter</a>
                                            </li>
                                        </ul>
                                    </div>
                                    @if (is_plugin_active('real-estate') && RealEstateHelper::isLoginEnabled())
