<label for="select-type" class="control-label">{{ __('Votre choix ici') }}</label>
<div class="dropdown mb-2 select-dropdown" data-text-default="{{ $labelDefault }}">
    <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuChoise" data-toggle="dropdown"
        ...
        <span id="choices_input">{{ $labelDefault }}</span>
        
    </button> 
    <input class="select-city-state form-control" type="hidden" id="dropdownMenuChoise" value="{{ $labelDefault }}">
