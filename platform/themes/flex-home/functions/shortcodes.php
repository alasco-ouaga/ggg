...
use Illuminate\Support\Facades\App;
 ...
 /* retrouverIndexReucuperationDe8Proprietés tres important Proprieter en vente ou en location a afficher, projet a afficher*/
//  is_featured_bani
app()->booted(function () {
    ...
    if (is_plugin_active('real-estate')) {
        ...
        add_shortcode('properties-for-sale', __('Properties for sale'), __('Properties for sale'), function (Shortcode $shortcode) {
            ...
            /* retrouverIndexReucuperationDe8Proprietés tres important*/
