...
@section('content')
    ...
    <div class="max-width-1200">
        ...
        >
            ...
            <div class="form-group mb-3">
                <label class="text-title-field"
                       for="real_estate_enable_auto_detect_visitor_currency">{{ trans('plugins/real-estate::currency.enable_auto_detect_visitor_currency') }}
                </label>
                <label class="me-2">
        ...
        >
            ...
            <div class="form-group mb-3">
                <label class="text-title-field"
                       for="real_estate_disabled_public_profile">{{ trans('plugins/real-estate::settings.disabled_public_profile') }}
                </label>
                <label class="me-2">
                    <input type="radio" name="real_estate_disabled_public_profile"
                           value="1"
                           @checked(RealEstateHelper::isDisabledPublicProfile())
                    >
                    {{ trans('core/setting::setting.general.yes') }}
                </label>
                <label>
        ...
        <x-core-setting::section
            :title="trans('settings.visibility_main_title')"
            :description="trans('settings.visibility_main_description')"
        >
        <!-- retrouveIndexVisibiliteMenuParamettre -->
        @livewire('visibility.main-menu-visibility')  
        </x-core-setting::section>

        
        <x-core-setting::section
            :title="trans('settings.visibility_footer_title')"
            :description="trans('settings.visibility_footer_description')"
        >
        
        <!-- retrouveIndexVisibiliteMenuParamettre -->
        @livewire('visibility.footer-visibility')  
        </x-core-setting::section>
