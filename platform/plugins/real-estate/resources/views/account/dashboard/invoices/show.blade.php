    ...
    <div class="container">
        <div class="card">
            ...
            <div class="card-footer text-center">
                <a href="{{ route('public.account.invoices.generate', ['id' => $invoice->id, 'type' => 'print']) }}" target="_blank" class="btn btn-danger">
                    <i class="fas fa-print"></i> {{ trans('plugins/real-estate::invoice.print') }}
                </a>
                <a href="{{ route('public.account.invoices.generate', ['id' => $invoice->id, 'type' => 'download']) }}" target="_blank" class="btn btn-success">
