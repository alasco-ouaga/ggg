@if ($showLabel && $showField)
    @if ($options['wrapper'] !== false)
        <div {!! $options['wrapperAttrs'] !!}>
            ...
            @if ($showField)
                <div id="multiple-upload" class="dropzone needsclick dz-sortable">
    ...
    @endif
    <!-- retrouveIndexMultiUploadImage -->
    <div id="preview-template" style="display: none;">
        <div class="dz-preview dz-file-preview col-2">
    ...
    <script>
        ...
        $(document).ready(function () {
            var dropzone = new Dropzone('#multiple-upload', {
                ...
                timeout: 0, // MB,
                maxFilesize: {{ RealEstateHelper::maxFilesizeUploadByAgent() }}, // MB
                maxFiles: {{ RealEstateHelper::maxPropertyImagesUploadByAgent() }}, // max files upload,
                paramName: 'file',
                acceptedFiles: 'image/*',
                ...
                removedfile: function(file) {
                    ...
                    if (dropzone.options.maxFiles === {{ RealEstateHelper::maxPropertyImagesUploadByAgent() }}) {
            ...
            @if ($options['value'] && is_array($options['value']))
                var files = [];
