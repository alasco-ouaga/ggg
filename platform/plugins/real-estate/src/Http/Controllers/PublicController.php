...
{
    /* retrouveIndexPublicControllerProjectEtProprietés */
    ...
    public function getAgent(
        ...
        $account = $accountRepository->getFirstBy([
                'username' => $username,
                'is_public_profile' => 1,
            ]);
        ...
        if (function_exists('admin_bar')) {
            admin_bar()->registerLink(__('Edit this agent'), route('account.edit', $account->id));
        }
