...
<body class="">
    ...
    <div class="container text-uppercase text-lg fw-bold fst-italic p-1">
        Rgi Immobilier:Propriété en recherche disponible
    </div>
    ...
    <div class="container bg-white">
        <div class="row">
            Cher(e) {{$custumer->last_name}}-{{$custumer->first_name}} ,
        </div>
        <div class="row text-align-justify p-3">
            <div class="container">
                <span> 
                    Nous tenons à vous informer qu'une propriété correspondante à votre recherche programmée a été rtrouvée.
                    La propriété est actuellement disponible sur la platforme flex-home.Pour plus d'infomation cliquer sur le lien suivant :
                    <a href="{{ $link }}" class="fw-bold fst-italic text-uppercase"> Veuillez cliquez ici pour plus de details</a> 
                </span>
            </div>
        </div>
