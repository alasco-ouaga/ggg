...
<body class="">
    ...
    <div class="container bg-white">
        ...
        <div class="row text-align-justify p-3">
            ...
            Cette transition vous donne accès à un ensemble de fonctionnalités étendu, vous permettant de bénéficier pleinement des services réservés à nos agents immobiliers. Vous pourrez 
            ainsi profiter de nouvelles opportunités, accéder à des outils spécialisés et collaborer plus efficacement avec notre équipe.
        </div>
        <div class="row text-align-justify fw-bold fst-italic text-danger p-3 mt-2">
            vous etes desormais agent immobilier
        </div>
